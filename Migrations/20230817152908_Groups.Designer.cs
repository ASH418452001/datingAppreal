...
namespace datingAppreal.Migrations
{
    ...
    [Migration("20230817152908_Groups")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("datingAppreal.Entities.UserLike", b =>
                {
            ...
            modelBuilder.Entity("datingAppreal.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("datingAppreal.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("datingAppreal.Entities.Message", b =>
                {
                    ...
                    b.HasOne("datingAppreal.Entities.User", "Sender")
            ...
            modelBuilder.Entity("datingAppreal.Entities.UserLike", b =>
                {
                    b.HasOne("datingAppreal.Entities.User", "SourceUser")
                        .WithMany("LikedUsers")
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("datingAppreal.Entities.User", "TargetUser")
            ...
            modelBuilder.Entity("datingAppreal.Entities.UserRole", b =>
                {
                    b.HasOne("datingAppreal.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
